...
\def\ThesisTitleCuniLogo#1{%
  ...
  \vfill%
  {\large Study programme: \StudyProgramme}
  \vfill%
  ...
  \vspace{5mm}%
  {\large Modelování časoprostorové dynamiky v primární zrakové kůře pomocí modelu hluboké neuronové sítě}\par
  % \vfill%
  \vspace{10mm}%
  {\bf\Large\ThesisTypeTitle}
}
...
{
\centerline{\vbox{\halign{\hbox to 0.35\hsize{\hfil #}&\hskip 0.5em\parbox[t]{0.45\hsize}{\raggedright #}\cr
\ifEN Supervisor:
