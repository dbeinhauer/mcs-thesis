...
\begin{figure}
    ...
    \caption{\textbf{An action potential} \textbf{a)} An action potential displayed by an oscilloscope. \textbf{b)} The parts of an action potential. The figure and the labels are taken from \emph{Neuroscience} (\citet{bear2020neuroscience}, p. 84).}
...
\begin{figure}
    ...
    \caption{\textbf{An anatomy of an eye} An illustration of an eye anatomy. "Created in BioRender. Beinhauer, D. (2025) https://BioRender.com/8n8epge".}
    \label{fig:eye}
\end{figure}
...
\begin{figure}
    ...
    \caption{\textbf{A layered anatomy of retina} An illustration of a structural layers of a retina. "Created in BioRender. Beinhauer, D. (2025) https://BioRender.com/oy5qz9v".}
